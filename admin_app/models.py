...
class Category(models.Model):
    ...
    discount_percentage = models.DecimalField(max_digits=5, decimal_places=2, default=0)  # Discount for the entire category
...
class Product(models.Model):
    ...
    image1 = models.ImageField(upload_to='product_images/', blank=True, null=True, max_length=500)
    image2 = models.ImageField(upload_to='product_images/', blank=True, null=True, max_length=500)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    is_active = models.BooleanField(default=True)
    ...
    def save(self, *args, **kwargs):  
        ...
        if self.discount_percentage == 0 and self.discount_price is not None:
            if self.price > self.discount_price:
                self.discount_percentage = (Decimal('1') - (self.discount_price / self.price)) * 100
            else:
